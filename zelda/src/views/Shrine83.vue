<template>
    <div class="container">
        ...
        <div v-if="!permission" class="body">
            ...
            <!--Video-->
            <iframe class="video" src="//player.bilibili.com/player.html?aid=82909939&bvid=BV1oJ411H7fg&cid=141799693&page=96" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"> </iframe>
